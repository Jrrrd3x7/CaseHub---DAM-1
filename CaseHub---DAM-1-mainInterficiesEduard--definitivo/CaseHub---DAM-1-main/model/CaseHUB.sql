con-- Base de datos completa para CaseHUB
-- Cubre los formularios HTML/PHP de:
...
-- 6. Buscar evento
-- 7. Eliminar evento
-- 8. Fichas individuales de cada evento
...
INSERT INTO usuarios (nombre, apellidos, email, pais, contrasena)
VALUES
('Jordi', 'Messi', 'jordi@email.com', 'ES', 'jordi123'),
('Daniil', 'Maximov', 'dmaximov@email.com', 'RU', 'dmx123');
...
BEGIN
    INSERT INTO usuarios (nombre, apellidos, email, pais, contrasena)
    VALUES (p_nombre, p_apellidos, p_email, p_pais, p_contrasena);
END $$
